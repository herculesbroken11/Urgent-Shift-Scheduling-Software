...
// IMPORTANT: Do not remove forwardRef — Badge is used inside Radix trigger components
// that require ref forwarding. Removing it causes NotFoundError DOM crashes.
